guard :concat, :type => "css", :files => %w[], :input_dir => "public/css", :output => "public/assets/css/styles.min"

guard :concat, :type => "js", :files => %w[], :input_dir => "public/js", :output => "public/assets/js/scripts.min"
...
guard :sass, :input => '../assets/sass', :output => 'public/assets/css', :line_numbers => true, :style => :compressed